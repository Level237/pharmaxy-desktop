  ...
  return (
    <div className="flex flex-col">
      <div className="text-left mb-10">
        <h1 className="text-3xl font-bold text-slate-900 mb-2 ">Administrateur principal</h1>
      ...
      <form onSubmit={onSubmit} className="space-y-6 mb-12">
        <div className="group">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Entrez le nom complet du gerant"
              value={data.name}
        ...
        <div className="flex gap-4 pt-4">
          <button
            ...
            className="flex-1 py-5 border-2 border-slate-100 hover:border-slate-200 text-slate-900 font-bold rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] tracking-widest uppercase text-sm disabled:opacity-50"
          >
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="flex-[2] py-5 bg-[#2720ff] hover:bg-[#1f19cc] text-white font-bold rounded-2xl flex items-center justify-center gap-3 transition-all active:scale-[0.98] tracking-widest uppercase text-sm disabled:opacity-50 shadow-lg shadow-[#2720ff]/25"
          >
