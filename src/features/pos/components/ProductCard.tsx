  ...
  return (
    <div className="bg-white p-5 rounded-2xl border border-[#E2E8F0] hover:border-[#10B981] transition-all group flex flex-col h-full shadow-sm hover:shadow-md">
      <div className="flex justify-between items-start mb-4">
        <div className={`h-10 w-10 rounded-xl flex items-center justify-center ${isCriticalStock ? "bg-red-50 text-red-500" : isLowStock ? "bg-orange-50 text-orange-500" : "bg-[#587dff]/20 text-[#587dff]"
          }`}>
          {isCriticalStock ? <AlertCircle className="h-5 w-5" /> : <Package className="h-5 w-5" />}
        </div>

        <span className={`px-2 py-1 rounded-md text-[10px] font-bold uppercase ${isCriticalStock ? "bg-red-50 text-red-600" : isLowStock ? "bg-orange-50 text-orange-600" : "bg-[#587dff]/20 text-[#587dff]"
          }`}>
      ...
      <button
        ...
        className="w-full bg-[#587dff] hover:bg-[#587dff]/90 cursor-pointer text-white p-3 rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg shadow-emerald-500/10 active:scale-95"
      >
