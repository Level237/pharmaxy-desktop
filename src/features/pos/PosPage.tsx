  ...
  return (
    <div className="flex flex-col h-full relative">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            {totalItems > 0 && (
              <span className="absolute -top-2 -right-2 bg-[#EF4444] text-white text-[10px] font-black h-5 w-5 rounded-full flex items-center justify-center border-2 border-white">
                {totalItems}
              </span>
            )}
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 pb-20">
        <div className="bg-slate-50 border-2 border-dashed border-[#CBD5E1] rounded-2xl flex flex-col items-center justify-center p-8 text-[#94A3B8] group hover:border-[#10B981] hover:text-[#10B981] transition-all cursor-pointer">
